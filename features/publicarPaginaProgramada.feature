Feature: Create Page schedule for later 
  ...
  Scenario: As a user I want to create and publish page
    ...
    When I click on button having css selector "login gh-btn"
    When I wait
    Then I expect that url contain "#/site"
    When I click on link having href "#/pages/"
    When I click on link having href "#/editor/page/"
    When I enter "Crear pagina programada" into input field having css selector "textarea[placeholder='Page Title']"
    When I enter "Pagina con publicacion programada" into input field having css selector "div.koenig-editor__editor.__mobiledoc-editor"
